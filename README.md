# MisMeeter 3.2.7 — Audio-clocked VBAN for iOS
## 3.2.7 system surfaces refinement
...
These remain first-class system surfaces in 3.2.7 on iOS 18.5:
...
- packages `MisMeeter-3.2.7-unsigned.ipa`
