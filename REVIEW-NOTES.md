# MisMeeter 3.2.5 — iOS 18.5 UI / Duplex Live Activity
...
- App and widget versions are 3.2.5 (build 36).
- CI artifact is now `MisMeeter-3.2.5-unsigned.ipa`.

## 3.2.5 Send / Widget refinement
...
- Version bumped to 3.2.5 (build 36); Xcode 16.4 / iOS 18.5 CI remains unchanged apart from artifact versioning.

## 3.2.5 Dynamic Island / Widget separation
...
- Version is 3.2.5 (build 36); Xcode 16.4 / iOS 18.5 CI remains the build baseline.
